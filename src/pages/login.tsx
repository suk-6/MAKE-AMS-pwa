...
const Login = () => {
	return (
		<div className="Page2 w-[430px] h-[932px] relative bg-white">
			...
			<div className=" w-[230px] h-[50px] left-[100px] top-[420px] absolute">
				...
				<div className=" left-[86px] top-[12px] absolute text-center text-black text-[22px] font-semibold font-['Pretendard']">
					로그인
				</div>
			</div>
			<div className="">
